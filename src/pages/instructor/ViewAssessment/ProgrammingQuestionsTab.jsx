...
export default function ProgrammingQuestionsTab({
  ...
  const filteredQuestions = availableProgrammingQuestions.filter(question =>
  ...
  return (
    <Box>
      <TextField
        fullWidth
        placeholder="Search programming questions by title or tags..."
        value={searchQuery}
        onChange={(e) => {
        ...
        {paginatedQuestions.length === 0 ? (
          <Grid item xs={12}>
            <Box sx={{ textAlign: 'center', py: 4, color: 'text.secondary' }}>
              ...
              <Typography>
                {searchQuery ? 'No programming questions found matching your search.' : 'No available programming questions.'}
              </Typography>
            </Box>
          </Grid>
        ) : (
