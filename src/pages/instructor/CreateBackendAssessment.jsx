...
import { ArrowBack, Api } from '@mui/icons-material';
import { useTheme } from '../../contexts/ThemeContext';
import { useTenant } from '../../contexts/TenantContext';
import toast from 'react-hot-toast';
import api from '../../services/api/apiClient';

const CreateBackendAssessment = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success('Backend assessment created successfully!');
        ...
        <Box display="flex" alignItems="center" gap={2}>
          ...
          <Box sx={{ flexGrow: 1 }}>
            ...
            <Typography variant="h6" sx={{ opacity: 0.9 }}>
              Django, Express, Spring Boot assessment
            </Typography>
          </Box>
        </Box>
      </Paper>
...
export default CreateBackendAssessment;
